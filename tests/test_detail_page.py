...
class TestProductDetailPage:
    ...
    def test_add_to_cart_button_add_products_to_cart(self):
        ...
        quantity = self.detail_page.get_quantity()
        first_cart_items_count = self.detail_page.\
            get_cart_items_count()

        self.detail_page.click_add_to_cart_button()
        last_cart_items_count = self.detail_page.get_cart_items_count()
